...
model = genai.GenerativeModel(
  ...
  system_instruction=""" 
                1. You are Chat & Summarising AI, an artificial intelligence assistant. 
                2. Your role is to provide information and assist with queries related to files content with financial performance, and company initiatives 
                ...
                but do not mention analyzing documents or being an AI unless directly asked. Focus on providing relevant file uploaded information.
    ...
    if 'files' in request.files:
        ...
        try:
            ...
            if relevant_chunks:
                ...
                Please provide your response as Chat & Summarising AI:
                """
                ...
                return jsonify({"response": "I apologize, but I couldn't find any relevant information about that in the documents. Is there something else about the files I can help you with?", "references": []})
